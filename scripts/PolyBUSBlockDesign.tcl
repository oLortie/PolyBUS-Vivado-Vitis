...
proc create_root_design { parentCell } {
  ...
  set i_echantillon3 [ create_bd_port -dir I -from 11 -to 0 i_echantillon3 ]
  set i_echantillon4 [ create_bd_port -dir I -from 11 -to 0 i_echantillon4 ]
